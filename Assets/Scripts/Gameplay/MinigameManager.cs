...
//        // Añadimos los puntos acumulados de este minijuego a cada jugador en el GameManager
//        if (GameManager.Instance != null)
//        {
//            foreach (var localScore in PlayerPoints)
//            {
//                GameManager.Instance.AddPointsToPlayerById(localScore.PlayerId, localScore.Score);
//            }
//        }
//        else
//        {
//            Debug.LogError("¡ERROR CRÍTICO! No existe GameManager.");
//        }

//        // Mostramos la intermisión para que los jugadores vean resultados.
//        // El siguiente mapa se cargará solo cuando todos pulsen el botón de listo.
...
//        Debug.Log($"Jugadores listos: {playersReadyCount.Value}");

//        int totalPlayers = NetworkManager.Singleton.ConnectedClients.Count;

//        if (playersReadyCount.Value >= totalPlayers)
//        {
//            Debug.Log("¡Todos los jugadores están listos! Cargando el siguiente mapa…");

//            // Seleccionamos un nuevo mapa aleatorio y lo cargamos.
//            if (GameManager.Instance != null)
//            {
...
//            else
//            {
//                // Fallback: si no existe GameManager, usa el cambio de mapa interno (sin cambiar de escena).
//                SwitchToLavaMap();
//            }
//        }
//    }
