...
public class IntermissionPlayerRow : MonoBehaviour
{
    ...
    public void Setup(string name, int currentScore, int addedPoints, Color color, string pantheonName)
    { 
        nameText.text = name;
        ...
        if (pantheonText != null)
        {
            ...
            pantheonText.color = new Color(1, 1, 1, 0.7f); // Blanco translúcido
        }
    }
